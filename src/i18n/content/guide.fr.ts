...
**Qualité** — chaque ligne affiche à quel point elle est proche d'un jet parfait, de 0 % (pire) à 100 % (parfait) ; pour les lignes négatives, les jets les plus bas obtiennent le meilleur score. Le pourcentage à côté du nom de l'artefact est sa **qualité** globale : la moyenne de toutes ses lignes.

**Fragments & améliorations** — supprimer un artefact (ou jeter un butin fraîchement obtenu) rapporte des **Fragments** : 1 pour un Léger, 2 pour un Moyen, 3 pour un Lourd. Les fragments paient les **améliorations** : chaque amélioration fait progresser une ligne non maximisée au hasard de 10 % de sa qualité — les positives augmentent, les négatives diminuent. Une ligne ne peut jamais dépasser la meilleure valeur qu'elle aurait pu obtenir. La première amélioration coûte 1 fragment, puis le coût augmente de 50 % (arrondi au supérieur) à chaque amélioration (1, 2, 3, 5, 8, 12, …). Supprimer un artefact amélioré rembourse la moitié des fragments dépensés dans ses améliorations, en plus de sa valeur de base.

**Suppression des lignes négatives** — les 5e et 10e améliorations suppriment chacune la ligne négative de pire qualité avant d'améliorer une ligne comme d'habitude. Un artefact Lourd finit par ne garder qu'une seule ligne négative, tandis que les Moyens et les Légers perdent toutes les leurs. Un artefact parfait n'est jamais bloqué : tant qu'une ligne négative peut encore être supprimée, chaque amélioration supplémentaire en supprime une — seul un artefact parfait sans ligne négative supprimable ne peut plus être amélioré.
