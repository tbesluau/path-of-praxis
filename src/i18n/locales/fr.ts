...
export const fr: TranslationSchema = {
  ...
  transcend: {
    btn: 'Transcender',
    pickerTitle: 'Choisissez une relique',
    pickerHint: 'Transcender réinitialise tout — y compris les ascensions, les points d\'univers et les artéfacts non équipés. Les artéfacts équipés et les reliques demeurent. Choisissez votre relique pour transcender.',
    confirmTitle: 'Transcender ?',
    confirmBody: 'Tout est réinitialisé — y compris les ascensions, les points d\'univers et les artéfacts non équipés. Les artéfacts équipés et les reliques demeurent.',
    relicFreeRebirth: 'Écho de renaissance',
    relicFreeRebirthDesc: 'Une fois par renaissance, gagnez votre progression de maîtrise non acquise sans mourir.',
    relicMultiAscend: 'Brise-chaînes',
    relicMultiAscendDesc: 'Ascendre peut accorder plusieurs ascensions à la fois, jusqu\'à votre niveau ennemi max −5.',
    relicExtraTrigger: 'Troisième main',
    relicExtraTriggerDesc: 'Débloque un emplacement de déclencheur d\'action supplémentaire permanent.',
    relicOnslaught: 'Déferlement',
    relicOnslaughtDesc: '30 % d\'ennemis en plus, 10 % d\'XP en plus, 10 % de dégâts en plus.',
    powerLabel: 'Transcendance : {n}',
    powerSummary: '+{xp} % XP · +{dmg} % dégâts · +{life} % vie max',
    relicsLabel: 'Reliques',
    ascendPlus: '{label} (+{n})',
  },
  artifacts: {
    title: 'Artefacts',
    ...
    scrapsLabel: 'Fragments : {n}',
    upgradeBtn: 'Améliorer {scraps}/{cost}',
