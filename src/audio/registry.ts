...
export const SFX: Record<SfxId, SfxDef> = {
  'action.physical':  { file: 'physical.ogg',   maxVoices: 4, throttleMs: 55, gain: 0.5, preload: true },
  'action.fire':      { file: 'fire.ogg',        maxVoices: 4, throttleMs: 55, gain: 0.5, preload: true },
  'action.lightning': { file: 'electric.ogg',    maxVoices: 4, throttleMs: 55, gain: 0.5, preload: true },
