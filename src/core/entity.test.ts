...
describe('entity', () => {
  ...
  describe('createEnemyEntity', () => {
    it('creates an enemyA entity at given position by default', () => {
    ...
    it('accepts an explicit team', () => {
      const e = createEnemyEntity('enemy-2', 0, 0, 'enemyB')
  ...
  describe('nearestTarget', () => {
    it('returns the closest entity of a different team', () => {
      const player = createPlayerEntity({ maxLife: 100, maxMana: 100, currentLife: 100, currentMana: 100 })
    ...
    it('ignores entities of the same team', () => {
      const player = createPlayerEntity({ maxLife: 100, maxMana: 100, currentLife: 100, currentMana: 100 })
      const ally = createPlayerEntity({ maxLife: 100, maxMana: 100, currentLife: 100, currentMana: 100 })
      ally.id = 'player-2'
