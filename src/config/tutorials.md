...
Open the Masteries panel to spend any mastery points you earned this run.
...
You unlocked a second action trigger slot! Open the battle configuration to set it up.
...
You've unlocked a higher enemy level! Tap the enemy level button to open the controls.
